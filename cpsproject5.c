...
supaverage=supsum/94;
michaverage=michsum/94;
huronaverage=huronsum/94;
erieaverage=eriesum/94;
ontaverage=ontsum/94;
stclairaverage=stclairsum/94;
...
printf("Lakes from warmest to coldest summer average temperature:\n");
